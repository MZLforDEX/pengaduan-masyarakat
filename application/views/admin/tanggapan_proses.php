        ...
        <div class="container-fluid">
          ...
          <div class="page-header-row">
            <div class="page-header">
              ...
              <p class="page-subtitle">Pengaduan yang sedang dalam proses tindak lanjut</p>
            </div>
          </div>
                ...
                <div class="complaint-card w-100">
                  <div class="card-header d-flex align-items-center">
                    <div class="d-flex align-items-center" style="gap: 10px;">
                      <div style="width: 36px; height: 36px; border-radius: 10px; background: rgba(245,158,11,0.1); display: flex; align-items: center; justify-content: center; color: #f59e0b; font-size: .85rem; font-weight: 700; flex-shrink: 0;">
                  ...
                  <div class="card-footer text-center">
                    <?= form_open('Admin/TanggapanController/tanggapan_pengaduan_selesai'); ?>
                      ...
                      <button class="premium-btn premium-btn-success premium-btn-sm w-100" name="selesai">
          ...
          <?php else : ?>
            <div class="text-center py-5">
              ...
              <p class="text-muted" style="font-size: .95rem;">Tidak ada pengaduan dalam proses</p>
            </div>
          <?php endif; ?>
