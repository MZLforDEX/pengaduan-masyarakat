...
class PengaduanController extends CI_Controller {
			...
			if ($upload_foto == FALSE) :
				...
				if ($resp) :
					...
					$this->Notifikasi_m->create([
						...
						'untuk_level'    => 'all',
						'isi'            => 'Pengaduan baru dari ' . $masyarakat['nama'],
						'url'            => 'Admin/TanggapanController/tanggapan_detail/' . $id_pengaduan,
	...
	public function pengaduan_batal($id)
	{
		...
		if ( ! empty($cek_data) && $cek_data['nik'] == $masyarakat['nik']) :
