...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <?php
      $dashboard_url = base_url('Masyarakat/DashboardController');
      if ($this->session->userdata('level') == 'admin' || $this->session->userdata('level') == 'petugas') {
          $dashboard_url = base_url('Admin/DashboardController');
      }
    ?>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('NotifikasiController'); ?>">Notifikasi</a>
          </div>
        </div>
      </li>
