        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <div>
              ...
              <p class="text-muted small mb-0">Halaman pemantauan laporan pengaduan Anda</p>
            </div>
            <a href="<?= base_url('Masyarakat/PengaduanController') ?>" class="d-none d-sm-inline-block btn btn-primary shadow-sm px-4 py-2" style="border-radius: 12px; font-weight: 600;">
              <i class="fas fa-edit fa-sm me-1"></i> Tulis Pengaduan Baru
            </a>
          </div>
          ...
          <div class="row">
            <div class="col-12 mb-4">
              <div class="card text-white border-0 shadow-sm overflow-hidden" style="border-radius: 20px; background: linear-gradient(135deg, #6366f1 0%, #2563eb 100%) !important;">
                <div class="card-body p-4 position-relative" style="z-index: 1;">
                  <div class="row align-items-center">
                    <div class="col-lg-8">
                      <h4 class="font-weight-bold mb-2 text-white">Selamat Datang Kembali, <?= htmlspecialchars(ucfirst($user_nama)); ?>! 👋</h4>
                      <p class="mb-0 text-white-50 opacity-90" style="font-size: 0.95rem; line-height: 1.6;">Suarakan aspirasi dan keluhan Anda langsung melalui portal resmi kami. Kami berkomitmen untuk memproses setiap laporan Anda secara cepat, profesional, dan terbuka.</p>
                    </div>
                    <div class="col-lg-4 text-right d-none d-lg-block pr-4">
                      <i class="fas fa-bullhorn fa-5x text-white" style="opacity: 0.15; font-size: 4.5rem;"></i>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="row">
              ...
              <div class="stat-card stat-card-blue">
                <div class="stat-card-body">
                  <div class="stat-card-content">
                    <div class="stat-card-label">Total Pengaduan Saya</div>
                    <div class="stat-card-value" data-count="<?= $total_pengaduan ?>">0</div>
                  </div>
                ...
                <div class="stat-card-footer">
                  <span><i class="fas fa-inbox"></i> Semua laporan yang telah dikirim</span>
                </div>
              </div>
            </div>
              ...
              <div class="stat-card stat-card-indigo">
                <div class="stat-card-body">
                  <div class="stat-card-content">
                    ...
                    <div class="stat-card-value" data-count="<?= $pengaduan_pending ?>">0</div>
                  </div>
                  <div class="stat-card-icon">
                ...
                <div class="stat-card-footer">
                  <span><i class="fas fa-history"></i> Laporan baru (belum diproses)</span>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="stat-card stat-card-amber">
                ...
                <div class="stat-card-footer">
                  <span><i class="fas fa-clock"></i> Dalam peninjauan petugas</span>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="stat-card stat-card-emerald">
                ...
                <div class="stat-card-footer">
                  <span><i class="fas fa-flag-checkered"></i> Pengaduan selesai diproses</span>
                </div>
              </div>
            </div>
            ...
            <div class="col-xl-6 col-lg-6 mb-4">
              <div class="card dashboard-card h-100">
                <div class="card-header d-flex align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold">Statistik Pengaduan Saya</h6>
                </div>
                <div class="card-body">
            ...
            <div class="col-xl-3 col-lg-3 mb-4">
              <div class="card dashboard-card h-100">
                <div class="card-header">
                  <h6 class="m-0 font-weight-bold">Progress Laporan</h6>
                </div>
                <div class="card-body d-flex flex-column justify-content-center">
                  <?php 
                    $total = max($total_pengaduan, 1);
            ...
            <div class="col-xl-3 col-lg-3 mb-4">
              <div class="card dashboard-card h-100">
                ...
                <div class="card-body d-flex flex-column justify-content-center gap-3">
                  <a href="<?= base_url('Masyarakat/PengaduanController') ?>" class="quick-action-btn">
                    <span class="quick-action-icon" style="background: rgba(99,102,241,0.12); color: #6366f1;">
                      <i class="fas fa-edit"></i>
                    </span>
                    <span class="quick-action-text">Tulis Pengaduan</span>
                    <i class="fas fa-chevron-right quick-action-arrow"></i>
                  </a>
                  <a href="<?= base_url('User/ProfileController') ?>" class="quick-action-btn">
                    <span class="quick-action-icon" style="background: rgba(16,185,129,0.12); color: #10b981;">
                      <i class="fas fa-user"></i>
                    </span>
                    <span class="quick-action-text">Profile Saya</span>
                    <i class="fas fa-chevron-right quick-action-arrow"></i>
                  </a>
                  <a href="<?= base_url('NotifikasiController') ?>" class="quick-action-btn">
                    <span class="quick-action-icon" style="background: rgba(245,158,11,0.12); color: #f59e0b;">
                      <i class="fas fa-bell"></i>
                    </span>
                    <span class="quick-action-text">Kotak Notifikasi</span>
                    <i class="fas fa-chevron-right quick-action-arrow"></i>
                  </a>
                </div>
              </div>
          ...
          <div class="card dashboard-card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold">Pengaduan Saya Terbaru</h6>
              <a href="<?= base_url('Masyarakat/PengaduanController') ?>" class="btn btn-sm btn-outline-primary rounded-pill px-3" style="font-size: .75rem;">
                ...
                <table class="table table-borderless mb-0">
                  ...
                  <tbody>
                    <?php if (empty($recent_complaints)) : ?>
                      <tr>
                        <td colspan="5" class="text-center text-muted py-4">Belum ada pengaduan yang Anda buat.</td>
                      </tr>
                    <?php else : ?>
                      ...
                      <tr>
                        ...
                        <td class="text-truncate" style="max-width: 320px;"><?= htmlspecialchars($r['isi_laporan']) ?></td>
                        <td><span class="badge-status <?= $status_class ?>"><?= $status_label ?></span></td>
                        <td class="text-center">
                          <a href="<?= base_url('Masyarakat/PengaduanController/pengaduan_detail/'.$r['id_pengaduan']) ?>" class="premium-btn premium-btn-outline premium-btn-sm">
                            Detail
                          </a>
                        </td>
                      </tr>
