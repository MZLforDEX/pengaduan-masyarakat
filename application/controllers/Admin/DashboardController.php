...
class DashboardController extends CI_Controller {
	...
	public function index()
	{
		...
		$data['pengaduan_pending'] = $this->db->get_where('pengaduan',['status' => '0'])->num_rows();
		$data['recent_complaints'] = $this->db->order_by('id_pengaduan', 'DESC')->limit(5)->get('pengaduan')->result_array();
