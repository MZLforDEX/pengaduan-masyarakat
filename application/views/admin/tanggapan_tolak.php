        ...
        <div class="container-fluid">
          ...
          <div class="page-header-row">
            <div class="page-header">
              ...
              <p class="page-subtitle">Pengaduan yang ditolak</p>
            </div>
          </div>
                ...
                <div class="complaint-card w-100">
                  <div class="card-header d-flex align-items-center">
                    <div class="d-flex align-items-center" style="gap: 10px;">
                      <div style="width: 36px; height: 36px; border-radius: 10px; background: rgba(239,68,68,0.1); display: flex; align-items: center; justify-content: center; color: #ef4444; font-size: .85rem; font-weight: 700; flex-shrink: 0;">
                  ...
                  <div class="card-footer text-center">
                    <span class="text-muted" style="font-size: .78rem; font-weight: 500;">
                      <i class="fas fa-times-circle text-danger"></i> Pengaduan ditolak
                    </span>
                  </div>
                </div>
              </div>
          ...
          <?php else : ?>
            <div class="text-center py-5">
              ...
              <p class="text-muted" style="font-size: .95rem;">Tidak ada pengaduan ditolak</p>
            </div>
          <?php endif; ?>
